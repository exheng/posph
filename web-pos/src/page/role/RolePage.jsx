...
function RolePage() {
    ...
    return (
        <div>
            ...
            <Modal title={form.getFieldValue("id") ? "Edit Role" : "Add Role"} open={state.visible} onCancel={handleCloseModal} footer={null}>
                <Form form={form} layout="vertical" onFinish={onFinish}>
                    ...
                    <Form.item>
                        <Space>
                            ...
                            <Button type="primary" htmlType="submit" >{form.getFieldValue("id") ? "Udate" : "Save"}</Button>
                        </Space>
                    </Form.item>
                </Form> 
            </Modal>
